...
- **Segmented Control & Filter Bars**: Separate Actions Bar (for scraping controls, bulk options, language toggling, and pill stats) and Curation Filter Bar (for refining card grid display) to optimize visual spacing and layout cleanliness.
